...
insert into Plateconf_file_path(Plateconf_file_location) values ('/Rnaidb_git/icr-gft-rnaidb/plate_conf_folder/plateconf_EPI.txt');
insert into Plateconf_file_path(Plateconf_file_location) values ('/Rnaidb_git/icr-gft-rnaidb/plate_conf_folder/EPI_plateconf.txt');
...
insert into Platelist_file_path(Platelist_file_location) values ('/Rnaidb_git/icr-gft-rnaidb/plate_list_folder/platelist_p6_v2.txt');
